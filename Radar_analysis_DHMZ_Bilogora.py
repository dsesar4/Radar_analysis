...
a = int(input('Area for analysis (0-Central Croatia, 1-Montain Croatia, 2-NW Croatia, 3-Gorski kotar): '))
year = int(input('Year: '))
...
areas = [[105,165,250,325],[40,270,140,410],[110,160,185,270],[20,260,100,330]]
